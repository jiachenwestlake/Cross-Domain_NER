...
class CPG(Module):
    ...
    def __init__(self, input_size, hidden_size, task_emb_size, domain_emb_size, layer_num=1, bidirectional=False,
                 bias=True, gpu=False):
...
class NetworkParamGenerator(Module):

    def __init__(self, input_size, hidden_size, data):
        super(NetworkParamGenerator, self).__init__()
        ...
        self.cpg_ = CPG(input_size, hidden_size, task_emb_size, domain_emb_size, layer_num, bilstm_flag, bias=True,
                        gpu=self.gpu)
